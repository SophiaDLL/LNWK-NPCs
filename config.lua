...
Config.NPCs = {
    {
        ...
        model = "mp_f_freemode_01", -- Spawned Ped Model
        coords = vector4(1700.769287, 4755.257324, 40.967773, 286.299194), -- Ped Location X, Y, Z, H
    ...
    },
    {
        ...
        coords = vector4(1703.116455, 4755.890137, 40.950928, 107.716537), -- Ped Location X, Y, Z, H
        animationDict = "anim@heists@heist_corona@single_team", -- Animation Directory
        animation = "single_team_loop_boss", -- Animation
        mpClothing = {
            components = { -- Clothing components
    ...
    {
        name = "fuck", -- Name for the NPC
        useMPClothing = false, -- Enable//Disable MP Clothing usage
        useMPGender = "male", -- Gender for MP Clothing
        model = "S_M_Y_Sheriff_01", -- Spawned Ped Model
        coords = vector4(1705.002197, 4756.008789, 40.950928, 93.543304), -- Ped Location X, Y, Z, H
        animationDict = "anim@heists@heist_corona@single_team", -- Animation Directory
        animation = "single_team_loop_boss", -- Animation
        mpClothing = {
            components = { -- Clothing components
    ...
    },
    {
        ...
        useMPGender = "male", -- Gender for MP Clothing
        model = "S_M_Y_Sheriff_01", -- Spawned Ped Model
        coords = vector4(1707.718628, 4756.602051, 40.934082, 263.622070), -- Ped Location X, Y, Z, H
        animationDict = "anim@heists@heist_corona@single_team", -- Animation Directory
        animation = "single_team_loop_boss", -- Animation
        mpClothing = {
            components = { -- Clothing components
